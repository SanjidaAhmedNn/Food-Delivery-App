...
import com.example.myfooddeliveryapp.databinding.PopularItemBinding
...
class PopularAdapter(private val items:List<String>, private val price:List<String>, private val image:List<Int>): RecyclerView.Adapter<PopularAdapter.PopularViewHolder>() {
    ...
    class PopularViewHolder(private val binding: PopularItemBinding): RecyclerView.ViewHolder(binding.root) {
        private val imageView = binding.imgVwImagePopular
        fun bind(item: String, price: String, images: Int) {
            binding.txtVwFoodNamePopular.text = item
            binding.txtVwPricePopular.text = price
