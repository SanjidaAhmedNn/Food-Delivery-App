...
import com.example.myfooddeliveryapp.databinding.BuyAgainItemBinding
...
class BuyAgainAdapter(private val buyAgainFoodName: ArrayList<String>,
    ...
    class BuyAgainViewHolder(private val binding: BuyAgainItemBinding): RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(foodName: String, foodPrice: String, foodImage: Int) {
            binding.txtVwBuyAgainFoodName.text= foodName
            binding.txtVwBuyAgainFoodPrice.text = foodPrice
            binding.txtVwBuyAgainFoodImage.setImageResource(foodImage)
